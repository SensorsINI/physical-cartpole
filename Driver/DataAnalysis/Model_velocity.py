...
def process_one_sided_file(file_path, side='pos', Q_normed=True):
    ...
    plt.figure()
    plt.plot(data['time'], data['positionD'])
    ...
    axs[0].plot(time[:int(len(time)*n/100.0)], v[:int(len(time)*n/100.0)],
...
# file_path_pos = PATH_TO_DATA + 'right-cartpole-2021-05-29-03-24-32.csv'
# file_path_neg = PATH_TO_DATA + 'left-cartpole-2021-05-29-03-26-47.csv'
# file_path_pos = PATH_TO_DATA + 'right-corrected-cartpole-2021-05-29-03-43-51.csv'
# file_path_neg = PATH_TO_DATA + 'left-corrected-cartpole-2021-05-29-03-41-12.csv'
# file_path_pos = PATH_TO_DATA + 'right-final-model-cartpole-2021-05-29-04-06-06.csv'
# file_path_neg = PATH_TO_DATA + 'left-final-model-cartpole-2021-05-29-04-03-36.csv'
file_path_pos = PATH_TO_DATA + 'right-no-0-motor-cartpole-2021-05-29-04-25-26.csv'
file_path_neg = PATH_TO_DATA + 'left-no-0-motor-cartpole-2021-05-29-04-26-35.csv'
...
plt.plot(Q_pos, v_pos, marker='o', label='Measured v_saturation')
plt.plot(Q_neg+22, v_neg, marker='o', label='Measured v_saturation')
