...
def check_motor_calibration(file_name):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Check whether corrected Q produces the configured saturation velocity.'
    )
    parser.add_argument(
        'file_name',
        nargs='?',
    ...
    check_motor_calibration(args.file_name)
