...
def set_firmware_parameters(CartPoleInstance, **kwargs):
    ...
    ANGLE_TARGET_FIRMWARE, ANGLE_KP_FIRMWARE, ANGLE_KI_FIRMWARE, ANGLE_KD_FIRMWARE = \
        ANGLE_TARGET_FIRMWARE_DEFAULT, ANGLE_KP_FIRMWARE_DEFAULT, ANGLE_KI_FIRMWARE_DEFAULT, ANGLE_KD_FIRMWARE_DEFAULT

    POSITION_TARGET_FIRMWARE, POSITION_CTRL_PERIOD_MS_FIRMWARE, POSITION_SMOOTHING_FIRMWARE, POSITION_KP_FIRMWARE, POSITION_KI_FIRMWARE, POSITION_KD_FIRMWARE = \
        POSITION_TARGET_FIRMWARE_DEFAULT, POSITION_CTRL_PERIOD_MS_FIRMWARE_DEFAULT, POSITION_SMOOTHING_FIRMWARE_DEFAULT, POSITION_KP_FIRMWARE_DEFAULT, POSITION_KI_FIRMWARE_DEFAULT, POSITION_KD_FIRMWARE_DEFAULT
    ...
    CartPoleInstance.set_angle_config_PID(
                                          ANGLE_KP_FIRMWARE,
                                          ANGLE_KI_FIRMWARE,
                                          ANGLE_KD_FIRMWARE,
                                          )
...
def get_firmware_parameters(CartPoleInstance):
    ...
    (ANGLE_TARGET,  # This must take care of both: target angle and 0-point offset
     ANGLE_AVG_LENGTH,
     added_latency,
     control_sync) = CartPoleInstance.get_angle_config()

    (ANGLE_KP,
     ANGLE_KI,
     ANGLE_KD) = CartPoleInstance.get_angle_config_PID()
    ...
    list_of_obtained_parameters = (ANGLE_TARGET, ANGLE_AVG_LENGTH, ANGLE_KP, ANGLE_KI, ANGLE_KD,
                                   POSITION_TARGET, POSITION_SMOOTHING, POSITION_KP, POSITION_KI, POSITION_KD
                                   )
