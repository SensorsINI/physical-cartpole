...
CONTROLLER_NAME = 'secloc-lqr-santiago'  # e.g. 'pid', 'lqr', 'mpc', 'do-mpc', 'do-mpc-discrete', 'neural-imitator'; 'pid' is a safe first smoke test on the Zedboard rig (neural checkpoints were trained on the Zybo-lab cartpole)
