...
set Library     "hls"
set IPName      "quadrature_encoder"
set Version     "1.0"
set DisplayName "Quadrature_encoder"
set Revision    "2113198912"
...
set sdx_kernel_name "quadrature_encoder"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/marcin/ICRA24/mlp_cartpole_robot/encoder_hls/encoder_hls/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {quadrature_encodebkb
...
## Variables
set Top "quadrature_encoder"
set TopNoPrefix "quadrature_encoder"
...
set Interfaces {
    s_axi_ENCODER_AXI {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_ENCODER_AXI"
        param_prefix "C_S_AXI_ENCODER_AXI"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {{0x10 reset W 0x0 "Data signal of reset" {{0 1 reset W 0 "Bit 0 to 0 Data signal of reset"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 count R 0x0 "Data signal of count" {{0 32 count R 0 "Bit 31 to 0 Data signal of count"}}} {0x1c count_ctrl R 0x0 "Control signal of count" {{0 1 count_ap_vld R 0 "Control signal count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 20 machine 64 combinational 0 latency 1 II x}
