...
set Library     "hls"
set IPName      "median_filter"
set Version     "1.0"
set DisplayName "Median_filter"
set Revision    "2007080942"
...
set xo_kernel_name "median_filter"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/santiago/Desktop/physical-cartpole/FPGA/CustomIPs/median_filter_hls/median_filter_hls/solution1"
set debug_dir "/home/santiago/Desktop/physical-cartpole/FPGA/CustomIPs/median_filter_hls/median_filter_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {median_filter_get_filtered_value_buffer_r
...
## Variables
set Top "median_filter"
set TopNoPrefix "median_filter"
...
set Interfaces {
    s_axi_MEDIAN {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_MEDIAN"
        param_prefix "C_S_AXI_MEDIAN"
        addr_bits "8"
        port_width "AWADDR 8 WDATA 32 WSTRB 4 ARADDR 8 RDATA 32"
        registers {{0x10 filtered_i W 0x0 "Data signal of filtered_i" {{0 32 filtered_i W 0 "Bit 31 to 0 of filtered_i"}}} {0x18 filtered_o R 0x0 "Data signal of filtered_o" {{0 32 filtered_o R 0 "Bit 31 to 0 of filtered_o"}}} {0x1c filtered_o_ctrl R 0x0 "Control signal of filtered_o" {{0 1 filtered_o_ap_vld R 0 "Control signal filtered_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 raw_i W 0x0 "Data signal of raw_i" {{0 32 raw_i W 0 "Bit 31 to 0 of raw_i"}}} {0x28 raw_o R 0x0 "Data signal of raw_o" {{0 32 raw_o R 0 "Bit 31 to 0 of raw_o"}}} {0x2c raw_o_ctrl R 0x0 "Control signal of raw_o" {{0 1 raw_o_ap_vld R 0 "Control signal raw_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 window_size W 0x0 "Data signal of window_size" {{0 32 window_size W 0 "Bit 31 to 0 of window_size"}}} {0x38 trim_count W 0x0 "Data signal of trim_count" {{0 32 trim_count W 0 "Bit 31 to 0 of trim_count"}}} {0x40 filter_mode W 0x0 "Data signal of filter_mode" {{0 32 filter_mode W 0 "Bit 31 to 0 of filter_mode"}}} {0x48 rail_low W 0x0 "Data signal of rail_low" {{0 32 rail_low W 0 "Bit 31 to 0 of rail_low"}}} {0x50 rail_high W 0x0 "Data signal of rail_high" {{0 32 rail_high W 0 "Bit 31 to 0 of rail_high"}}} {0x58 dz_status_i W 0x0 "Data signal of dz_status_i" {{0 32 dz_status_i W 0 "Bit 31 to 0 of dz_status_i"}}} {0x60 dz_status_o R 0x0 "Data signal of dz_status_o" {{0 32 dz_status_o R 0 "Bit 31 to 0 of dz_status_o"}}} {0x64 dz_status_o_ctrl R 0x0 "Control signal of dz_status_o" {{0 1 dz_status_o_ap_vld R 0 "Control signal dz_status_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 dz_window_i W 0x0 "Data signal of dz_window_i" {{0 32 dz_window_i W 0 "Bit 31 to 0 of dz_window_i"}}} {0x70 dz_window_o R 0x0 "Data signal of dz_window_o" {{0 32 dz_window_o R 0 "Bit 31 to 0 of dz_window_o"}}} {0x74 dz_window_o_ctrl R 0x0 "Control signal of dz_window_o" {{0 1 dz_window_o_ap_vld R 0 "Control signal dz_window_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 dz_age_i W 0x0 "Data signal of dz_age_i" {{0 32 dz_age_i W 0 "Bit 31 to 0 of dz_age_i"}}} {0x80 dz_age_o R 0x0 "Data signal of dz_age_o" {{0 32 dz_age_o R 0 "Bit 31 to 0 of dz_age_o"}}} {0x84 dz_age_o_ctrl R 0x0 "Control signal of dz_age_o" {{0 1 dz_age_o_ap_vld R 0 "Control signal dz_age_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 dz_low_count R 0x0 "Data signal of dz_low_count" {{0 32 dz_low_count R 0 "Bit 31 to 0 of dz_low_count"}}} {0x8c dz_low_count_ctrl R 0x0 "Control signal of dz_low_count" {{0 1 dz_low_count_ap_vld R 0 "Control signal dz_low_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 dz_high_count R 0x0 "Data signal of dz_high_count" {{0 32 dz_high_count R 0 "Bit 31 to 0 of dz_high_count"}}} {0x9c dz_high_count_ctrl R 0x0 "Control signal of dz_high_count" {{0 1 dz_high_count_ap_vld R 0 "Control signal dz_high_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_MEDIAN xadc_stream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
source -notrace "/media/santiago/Data/tools/Xilinx/Vitis/2020.1/common/scripts/ipxhls.tcl"
