...
set solution_dir "/home/marcin/IROS2024/mlp_cartpole_robot/median_filter_hls/median_filter_hls/solution1"
set debug_dir "/home/marcin/IROS2024/mlp_cartpole_robot/median_filter_hls/median_filter_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {median_filter_srem_17ns_16s_16_21_seq_1
...
set Interfaces {
    s_axi_MEDIAN {
        ...
        registers {{0x10 median_i W 0x0 "Data signal of median_i" {{0 32 median_i W 0 "Bit 31 to 0 of median_i"}}} {0x18 median_o R 0x0 "Data signal of median_o" {{0 32 median_o R 0 "Bit 31 to 0 of median_o"}}} {0x1c median_o_ctrl R 0x0 "Control signal of median_o" {{0 1 median_o_ap_vld R 0 "Control signal median_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 window_size W 0x0 "Data signal of window_size" {{0 32 window_size W 0 "Bit 31 to 0 of window_size"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
