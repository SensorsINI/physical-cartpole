...
set Library     "hls"
set IPName      "secloc_shell"
set Version     "1.0"
set DisplayName "Secloc_shell"
set Revision    "2007101122"
...
set xo_kernel_name "secloc_shell"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/santiago/Desktop/physical-cartpole/FPGA/CustomIPs/secloc_shell_hls/secloc_shell_hls/solution1"
set debug_dir "/home/santiago/Desktop/physical-cartpole/FPGA/CustomIPs/secloc_shell_hls/secloc_shell_hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {secloc_shell_write_request_packet_words_V
...
## Variables
set Top "secloc_shell"
set TopNoPrefix "secloc_shell"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 angleD W 0x0 "Data signal of angleD" {{0 32 angleD W 0 "Bit 31 to 0 of angleD"}}} {0x18 angle_cos W 0x0 "Data signal of angle_cos" {{0 32 angle_cos W 0 "Bit 31 to 0 of angle_cos"}}} {0x20 angle_sin W 0x0 "Data signal of angle_sin" {{0 32 angle_sin W 0 "Bit 31 to 0 of angle_sin"}}} {0x28 position W 0x0 "Data signal of position" {{0 32 position W 0 "Bit 31 to 0 of position"}}} {0x30 positionD W 0x0 "Data signal of positionD" {{0 32 positionD W 0 "Bit 31 to 0 of positionD"}}} {0x38 target_equilibrium W 0x0 "Data signal of target_equilibrium" {{0 32 target_equilibrium W 0 "Bit 31 to 0 of target_equilibrium"}}} {0x40 target_position W 0x0 "Data signal of target_position" {{0 32 target_position W 0 "Bit 31 to 0 of target_position"}}} {0x48 angle W 0x0 "Data signal of angle" {{0 32 angle W 0 "Bit 31 to 0 of angle"}}} {0x50 tick W 0x0 "Data signal of tick" {{0 32 tick W 0 "Bit 31 to 0 of tick"}}} {0x58 log_base W 0x0 "Data signal of log_base" {{0 32 log_base W 0 "Bit 31 to 0 of log_base"}}} {0x60 ref_period_ticks W 0x0 "Data signal of ref_period_ticks" {{0 32 ref_period_ticks W 0 "Bit 31 to 0 of ref_period_ticks"}}} {0x68 dead_ang W 0x0 "Data signal of dead_ang" {{0 32 dead_ang W 0 "Bit 31 to 0 of dead_ang"}}} {0x70 dead_pos W 0x0 "Data signal of dead_pos" {{0 32 dead_pos W 0 "Bit 31 to 0 of dead_pos"}}} {0x78 control_flags W 0x0 "Data signal of control_flags" {{0 32 control_flags W 0 "Bit 31 to 0 of control_flags"}}} {0x80 Q R 0x0 "Data signal of Q" {{0 32 Q R 0 "Bit 31 to 0 of Q"}}} {0x84 Q_ctrl R 0x0 "Control signal of Q" {{0 1 Q_ap_vld R 0 "Control signal Q_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 status R 0x0 "Data signal of status" {{0 32 status R 0 "Bit 31 to 0 of status"}}} {0x94 status_ctrl R 0x0 "Control signal of status" {{0 1 status_ap_vld R 0 "Control signal status_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 update_count R 0x0 "Data signal of update_count" {{0 32 update_count R 0 "Bit 31 to 0 of update_count"}}} {0xa4 update_count_ctrl R 0x0 "Control signal of update_count" {{0 1 update_count_ap_vld R 0 "Control signal update_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 nn_wait_cycles R 0x0 "Data signal of nn_wait_cycles" {{0 32 nn_wait_cycles R 0 "Bit 31 to 0 of nn_wait_cycles"}}} {0xb4 nn_wait_cycles_ctrl R 0x0 "Control signal of nn_wait_cycles" {{0 1 nn_wait_cycles_ap_vld R 0 "Control signal nn_wait_cycles_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL gate_req gate_resp"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
