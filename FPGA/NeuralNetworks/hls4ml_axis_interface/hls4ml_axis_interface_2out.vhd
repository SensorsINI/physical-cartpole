...
architecture RTL of mlp is
    ...
    signal prediction_ap_valid_0              : STD_LOGIC; -- @suppress "signal prediction_ap_valid is never read"
    signal prediction_ap_valid_1              : STD_LOGIC; -- @suppress "signal prediction_ap_valid is never read"
...
begin
    ...
    inst_mlp : entity work.myproject
        port map(
            ...
            layer8_out_0_V         => prediction_data(MLP_OUTPUT_BIT_WIDTH - 1 downto MLP_OUTPUT_BIT_WIDTH / 2),
            layer8_out_0_V_ap_vld  => prediction_ap_valid_0,
            layer8_out_1_V         => prediction_data(MLP_OUTPUT_BIT_WIDTH / 2 - 1 downto 0),
            layer8_out_1_V_ap_vld  => prediction_ap_valid_1
        );
