...
#
# Generated by Vivado on Fri Sep 12 17:34:00 CEST 2025
...
set _xil_proj_name_ "CartpoleDriverZynq_AXIS_Zedboard"
...
set script_file "CartpoleDriverZynq_AXIS_Zedboard.tcl"
...
# Zedboard board files are vendored in this repo (copied from digilent-vivado-boards)
set board_repo [file normalize "$origin_dir/board_files"]
...
set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/bram_sdp.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/edgedrnn.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/hpc.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/hpe.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/ieu.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/mem_acc.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/mem_state.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/sigmoid_lut.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../Driver/CartPoleSimulation/SI_Toolkit/src/SI_Toolkit/Functions/Pytorch/EdgeDRNN/hdl/tanh_lut.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/../Interfaces/controller_axilite.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "cartpole_driver_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../Constraints/cartpole_pinout_zed.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Constraints/cartpole_pinout_zed.xdc"
set file [file normalize $file]
...
set_property -name "top" -value "PmodAD1_AXI" -objects $obj
set_property -name "top_file" -value "../CustomIPs/PmodAD1/PmodAD1_AXI.v" -objects $obj
...
# module references:
# PmodAD1_AXI, edgedrnn_wrapper, controller_axilite
...
# NOTE: The former HLS4ML hierarchy (axi_dma_0 + axi_mem_intercon + mlp_axis_interface)
# was replaced by a single AXI4-Lite module reference (controller_axilite) named
# CONTROLLER_AXILITE_0 inside HARDWARE_ACCEL. The firmware auto-detects it through
# XPAR_HARDWARE_ACCEL_CONTROLLER_AXILITE_0_BASEADDR (see Firmware hw_platform_config.h).
...
proc create_hier_cell_HARDWARE_ACCEL { parentCell nameHier } {
  ...
  # Create instance: CONTROLLER_AXILITE_0 (hls4ml controller behind an AXI4-Lite shell)
  set block_name controller_axilite
  set block_cell_name CONTROLLER_AXILITE_0
  if { [catch {set CONTROLLER_AXILITE_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CONTROLLER_AXILITE_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins CONTROLLER_AXILITE_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net s_axi_1 [get_bd_intf_pins EdgeDRNN/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ACLK] [get_bd_pins EdgeDRNN/m_axi_mm2s_aclk] [get_bd_pins CONTROLLER_AXILITE_0/S_AXI_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_25M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins ext_reset_in] [get_bd_pins rst_ps7_0_25M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins EdgeDRNN/m_axi_mm2s_aresetn] [get_bd_pins CONTROLLER_AXILITE_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_25M/peripheral_aresetn]
...
proc create_hier_cell_CartPoleInterface { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Vaux0_0_1 [get_bd_intf_pins Vaux0_0] [get_bd_intf_pins xadc_wiz_0/Vaux0]
  ...
  # Zedboard has no RGB LED: RGB_LED_GPIO is kept (firmware compatibility) but not routed to pins
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Vaux0_0_1 [get_bd_intf_ports Vaux0_0] [get_bd_intf_pins CartPoleInterface/Vaux0_0]
  connect_bd_intf_net -intf_net Vp_Vn_1_1 [get_bd_intf_ports Vp_Vn_1] [get_bd_intf_pins CartPoleInterface/Vp_Vn_1]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports sws_8bits] [get_bd_intf_pins SWITCHES_AND_LEDS_GPIO/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports leds_8bits] [get_bd_intf_pins SWITCHES_AND_LEDS_GPIO/GPIO2]
  # RGB_LED_GPIO/GPIO left unconnected: Zedboard has no RGB LED
  ...
  assign_bd_address -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs HARDWARE_ACCEL/CONTROLLER_AXILITE_0/S_AXI/reg0] -force
