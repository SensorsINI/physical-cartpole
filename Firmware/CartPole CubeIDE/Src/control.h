...
// Defaults
#define CONTROL_ANGLE_SET_POINT			3145 // for unit 2 from aliexpress // for unit 1 from ali 3383 // set it to exactly the vertical position of the pendulum, by printing values and then averaging them
...
#define CONTROL_POSITION_KP             0.0 //20.0f
