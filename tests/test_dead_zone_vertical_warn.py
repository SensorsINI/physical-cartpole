...
ANGLE_360_DEG_IN_ADC_UNITS = 4143.32
DEAD_ZONE_VERTICAL_WARN_DEG = 20.0
ANGLE_HANGING_POLOLU = 1016.84
...
def test_dead_zone_at_upright_warns():
    ...
    assert dead_zone_near_vertical(2024.72) is True
...
def test_threshold_is_twenty_degrees():
    ...
    assert math.isclose(thresh, 4143.32 * 20.0 / 360.0)
