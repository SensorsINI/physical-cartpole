# Short-pole SecLoc bitstream + Debug ELF. Same JTAG flow as program_cartpole_slider.tcl.
# Prefer FPGA/bitstreams/cartpole_short_pole_secloc.bit; fall back to the live impl_1 bit.

set bit /home/marcin/PycharmProjects/physical-cartpole/FPGA/bitstreams/cartpole_short_pole_secloc.bit
if {![file exists $bit]} {
...
con
after 500
puts "PROGRAM_OK cartpole_short_pole"
exit 0
