...
#
# Generated by Vivado on Mon Apr 24 12:42:27 CEST 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../../../../../vivado-library-zmod-v1-2019.1-2"]"]"\
  ]
  foreach ipath $paths {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.557791",
   "Default View_TopLeft":"-273,-792",
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 0 -120 340 -540 830 -400 1240
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 850 -320n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 4 10 -130 330 -550 NJ -550 1220
preplace netloc PmodDHB1_0_Pmod_out_pin2_o 1 2 3 820J -570 NJ -570 1610J
preplace netloc PmodDHB1_0_Pmod_out_pin1_o 1 2 3 810J -580 NJ -580 1620J
preplace netloc Pmod_out_pin3_i_0_1 1 0 3 -10J -560 N -560 800
preplace netloc Pmod_out_pin4_i_0_1 1 0 3 NJ -70 360 -260 800
...
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 840J -410 1230
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 4 350 -620 NJ -620 NJ -620 1600
preplace netloc ps7_0_axi_periph_M01_AXI 1 1 4 360 -610 NJ -610 NJ -610 1590
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 4 370 -600 NJ -600 NJ -600 1580
preplace netloc ps7_0_axi_periph_M03_AXI 1 0 5 10 -590 NJ -590 NJ -590 NJ -590 1570
preplace netloc Vaux15_0_1 1 0 1 N -290
levelinfo -pg 1 -30 170 590 1040 1420 1640
pagesize -pg 1 -db -bbox -sgen -280 -670 1870 710
"
}
