...
#
# Generated by Vivado on Tue Apr 25 09:23:28 CEST 2023
...
proc cr_bd_design_1 { parentCell } {
  ...
  set Pmod_out_Directionpin1 [ create_bd_port -dir O Pmod_out_Directionpin1 ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PmodDHB1_0/AXI_LITE_GPIO] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins PmodDHB1_0/MOTOR_FB_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PmodDHB1_0/PWM_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net PmodDHB1_0_Pmod_out_pin1_o [get_bd_ports Pmod_out_Directionpin1] [get_bd_pins PmodDHB1_0/Pmod_out_pin1_o]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PmodDHB1_0/motor_fb_axi_aresetn] [get_bd_pins PmodDHB1_0/pwm_axi_aresetn] [get_bd_pins PmodDHB1_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.47202",
   "Default View_TopLeft":"304,-520",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1640 -y -200 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1640 -y -180 -defaultsOSRD
preplace port Vaux15_0 -pg 1 -lvl 0 -x -30 -y -290 -defaultsOSRD
preplace port port-id_Pmod_in_Sensefeedback_A -pg 1 -lvl 0 -x -30 -y -50 -defaultsOSRD
preplace port port-id_Pmod_in_Sensefeedback_B -pg 1 -lvl 0 -x -30 -y -70 -defaultsOSRD
preplace port port-id_Pmod_out_Directionpin1 -pg 1 -lvl 5 -x 1640 -y -220 -defaultsOSRD
preplace port port-id_Pmod_out_Enablepin -pg 1 -lvl 5 -x 1640 -y -240 -defaultsOSRD
preplace port port-id_vn_in_0 -pg 1 -lvl 0 -x -30 -y -330 -defaultsOSRD
preplace port port-id_vp_in_0 -pg 1 -lvl 0 -x -30 -y -310 -defaultsOSRD
preplace inst PmodDHB1_0 -pg 1 -lvl 2 -x 590 -y -400 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 590 -y -120 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 4 -x 1420 -y -390 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 3 -x 1040 -y -300 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 1 -x 170 -y -310 -defaultsOSRD
preplace netloc PmodDHB1_0_Pmod_out_pin1_o 1 2 3 790J -580 NJ -580 1610J
preplace netloc PmodDHB1_0_Pmod_out_pin2_o 1 2 3 800J -570 NJ -570 1600J
preplace netloc Pmod_out_pin3_i_0_1 1 0 3 -10J -560 N -560 780
preplace netloc Pmod_out_pin4_i_0_1 1 0 3 NJ -70 350 -260 780
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 0 -120 330 -540 810 -400 1230
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 830 -320n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 4 10 -130 320 -550 NJ -550 1210
preplace netloc vn_in_0_1 1 0 1 NJ -330
preplace netloc vp_in_0_1 1 0 1 NJ -310
preplace netloc Vaux15_0_1 1 0 1 N -290
preplace netloc processing_system7_0_DDR 1 2 3 NJ -200 N -200 N
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ -180 N -180 N
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 820J -410 1220
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 4 340 -620 NJ -620 NJ -620 1590
preplace netloc ps7_0_axi_periph_M01_AXI 1 1 4 350 -610 NJ -610 NJ -610 1580
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 4 360 -600 NJ -600 NJ -600 1570
preplace netloc ps7_0_axi_periph_M03_AXI 1 0 5 10 -590 NJ -590 NJ -590 NJ -590 1560
levelinfo -pg 1 -30 170 590 1040 1420 1640
pagesize -pg 1 -db -bbox -sgen -250 -670 1850 710
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zedboard/zedboard.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zedboard.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zedboard.srcs/utils_1/imports/impl_1" -objects $obj
