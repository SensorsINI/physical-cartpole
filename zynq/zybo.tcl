...
#
# Generated by Vivado on Tue Apr 25 10:39:54 CEST 2023
...
#
# 1. This project restoration tcl script (zybo.tcl) that was generated.
#
...
#
#    "/home/arios/Projects/cart_pole/physical-cartpole/zynq/pinout_zybo.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/pinout_zybo.xdc"]"\
  ]
  foreach ifile $files {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../vivado-library-zmod-v1-2019.1-2"]" $obj
...
set file "[file normalize "$origin_dir/pinout_zybo.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/pinout_zybo.xdc"
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/pinout_zybo.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/pinout_zybo.xdc"]" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  digilentinc.com:IP:PmodDHB1:1.0\
  ...
  set Pmod_out_Directionpin [ create_bd_port -dir O Pmod_out_Directionpin ]
  set Pmod_out_Enablepin [ create_bd_port -dir O Pmod_out_Enablepin ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins PmodDHB1_0/AXI_LITE_GPIO] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PmodDHB1_0/MOTOR_FB_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PmodDHB1_0/PWM_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net PmodDHB1_0_Pmod_out_pin1_o [get_bd_ports Pmod_out_Directionpin] [get_bd_pins PmodDHB1_0/Pmod_out_pin1_o]
  connect_bd_net -net PmodDHB1_0_Pmod_out_pin2_o [get_bd_ports Pmod_out_Enablepin] [get_bd_pins PmodDHB1_0/Pmod_out_pin2_o]
  connect_bd_net -net Pmod_out_pin3_i_0_1 [get_bd_ports Pmod_in_Sensefeedback_A] [get_bd_pins PmodDHB1_0/Pmod_out_pin3_i]
  connect_bd_net -net Pmod_out_pin4_i_0_1 [get_bd_ports Pmod_in_Sensefeedback_B] [get_bd_pins PmodDHB1_0/Pmod_out_pin4_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodDHB1_0/motor_fb_axi_aclk] [get_bd_pins PmodDHB1_0/pwm_axi_aclk] [get_bd_pins PmodDHB1_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodDHB1_0/motor_fb_axi_aresetn] [get_bd_pins PmodDHB1_0/pwm_axi_aresetn] [get_bd_pins PmodDHB1_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodDHB1_0/AXI_LITE_GPIO/Reg0] -force
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodDHB1_0/MOTOR_FB_AXI/Reg0] -force
  assign_bd_address -offset 0x40002000 -range 0x00002000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodDHB1_0/PWM_AXI/Reg0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.567708",
   "Default View_TopLeft":"-299,-638",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1530 -y -170 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1530 -y -150 -defaultsOSRD
preplace port Vaux15_0 -pg 1 -lvl 0 -x 0 -y -420 -defaultsOSRD
preplace port port-id_Pmod_in_Sensefeedback_A -pg 1 -lvl 0 -x 0 -y 30 -defaultsOSRD
preplace port port-id_Pmod_in_Sensefeedback_B -pg 1 -lvl 0 -x 0 -y 50 -defaultsOSRD
preplace port port-id_Pmod_out_Directionpin -pg 1 -lvl 4 -x 1530 -y 120 -defaultsOSRD
preplace port port-id_Pmod_out_Enablepin -pg 1 -lvl 4 -x 1530 -y 160 -defaultsOSRD
preplace port port-id_vn_in_0 -pg 1 -lvl 0 -x 0 -y -460 -defaultsOSRD
preplace port port-id_vp_in_0 -pg 1 -lvl 0 -x 0 -y -440 -defaultsOSRD
preplace inst PmodDHB1_0 -pg 1 -lvl 1 -x 530 -y 180 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 530 -y -120 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 1320 -y -310 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -x 960 -y -270 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 1 -x 530 -y -440 -defaultsOSRD
preplace netloc PmodDHB1_0_Pmod_out_pin1_o 1 1 3 770J 120 NJ 120 NJ
preplace netloc PmodDHB1_0_Pmod_out_pin2_o 1 1 3 780J 160 NJ 160 NJ
preplace netloc Pmod_out_pin3_i_0_1 1 0 2 NJ 30 750
preplace netloc Pmod_out_pin4_i_0_1 1 0 2 30J 40 730
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 50 -620 740 -390 1160
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 780 -290n
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 3 60 -260 730J -380 1170
preplace netloc vn_in_0_1 1 0 1 20J -480n
preplace netloc vp_in_0_1 1 0 1 30J -460n
preplace netloc Vaux15_0_1 1 0 1 40J -440n
preplace netloc processing_system7_0_DDR 1 1 3 NJ -170 1170 -130 1500
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -150 1140 -120 1510
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 750J -400 1150
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 90 -630 NJ -630 NJ -630 1470
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 4 70 -250 770J -370 1150J -110 1490
preplace netloc ps7_0_axi_periph_M02_AXI 1 0 4 90 -230 760J -100 NJ -100 1480
preplace netloc ps7_0_axi_periph_M03_AXI 1 0 4 80 -240 770J -90 NJ -90 1470
levelinfo -pg 1 0 530 960 1320 1530
pagesize -pg 1 -db -bbox -sgen -250 -750 1750 640
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zybo/zybo.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zybo.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zybo.srcs/utils_1/imports/impl_1" -objects $obj
